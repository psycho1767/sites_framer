    ...
    <>
      <div className="w-full max-w-[100rem] mx-auto my-2.5 min-h-[100dvh] bg-light ">
          ...
          <div className="w-full h-[5.0625rem] flex flex-col justify-center items-center gap-3 mb-2">
            ...
            <div className="w-11/12 box-border  flex-1 flex justify-between items-center ">
              <img
                ...
                alt="MessageBird"
              />
              <img loading="lazy" className="hero_background__footer " src={Rarify} alt="Rarify" />
              <img loading="lazy" className="hero_background__footer " src={Zapier} alt="Zapier" />
              <img
                loading="lazy"
                className="hero_background__footer "
                src={Superhuman}
        ...
        <section
          ...
          <div className="absolute -top-[10.45rem] right-[13.0625rem] w-[21.125rem] h-[15.25rem] border-[3px] border-canvas-pink flex flex-col ">
            <div className="relative w-full flex-1 rounded-2xl shadow-md border-white/5">
          ...
          <div className=" relative w-full flex-1   ">
            <div className="absolute inset-10 flex flex-col justify-start items-center gap-5  ">
              <div className="w-full relative flex-1 flex flex-col ">
                <div className="example__item_bg w-full flex-1">
                  <div className="absolute inset-1 bg-linear-to-r from-linerBlue via-mid-linear to-end-linear rounded-[20px] overflow-hidden">
                    ...
                    <button className="absolute top-10 right-10 cursor-pointer z-10">
                      <svg
                        width="30"
                        height="31"
                        viewBox="0 0 30 31"
                    ...
                    <div className="absolute inset-x-10 top-10 min-h-[30.75rem] flex flex-col justify-start items-start gap-10 cursor-default ">
                      <div className="w-[18rem] h-max flex flex-col justify-start items-start gap-2.5">
                        <span className="text-[24px] leading-7 font-bold text-light">
                          Start with AI
                        </span>
                        <span className="text-[15px] leading-5 font-medium text-[#FEFEFE]">
                          Generate a beautiful first version of your site, then go in and customize.
                        </span>
                      </div>
                      <img
                        loading="lazy"
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 w-[31.25rem] h-[9.8125rem] top-[9.6875rem] rounded-[.9375rem] bg-light shadow-(--shadow-win)  ">
                      <div className="absolute inset-4  flex flex-col gap-4 justify-start items-center">
                        ...
                        <div className="w-full text-[14px] font-medium leading-5">
                          A recipe site for professional chef Abi Roman. Use vivid colors and modern
                          type. Give an overview of recipies in a grid.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-full relative flex-1 flex justify-between items-center gap-5 ">
                <div className="w-[50.5rem] h-[31.25rem] example__item_bg">
                  <div className="overflow-hidden absolute inset-1 rounded-[20px] bg-radial from-center-radial/70 to-white/40 backdrop-blur-lg">
                    ...
                    <div className="absolute inset-10 flex flex-col justify-start items-start gap-10 ">
                      <div className="w-[18rem] flex flex-col gap-2.5 ">
                        <span className="w-full text-[1.5rem] font-bold leading-7 text-hero-center  ">
                          Design & Layout
                        </span>
                        <span className="w-full text-[.9375rem] leading-5 text-hero-center font-medium opacity-80">
                          Use positioning options to fix topbars, sidebars, badges, and backgrounds.
                        </span>
                      </div>
                ...
                <div className="flex-1 h-[31.25rem] example__item_bg">
                  ...
                  <div className="absolute inset-1 bg-linear-240 from-linerBlue to-example-blue rounded-[1.25rem] overflow-hidden">
                    <div className="absolute top-10 left-10 w-10/12  flex flex-col justify-start items-start gap-2.5">
                      <span className="text-white text-[1.5rem] leading-7 font-bold">
                        Figma Plugin
                      </span>
                      <span className="text-white text-[.9375rem] font-medium leading-5 w-[15.4375rem]">
                        Copy and paste your web designs from Figma to Framer.
                      </span>
                    </div>
                    <img
                      loading="lazy"
              ...
              <div className="w-full relative flex-1 flex flex-col bg-blue-200"></div>
